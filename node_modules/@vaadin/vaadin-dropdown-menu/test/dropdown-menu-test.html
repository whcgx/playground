      ...
      <vaadin-dropdown-menu placeholder="placeholder">
        <template>
          <vaadin-list-box>
            ...
            <mock-item value="" disabled>Disabled</mock-item>
          </vaadin-list-box>
        </template>
...
describe('vaadin-dropdown-menu menu-element', () => {
  let dropdown;

  beforeEach(() => dropdown = fixture('menu-element'));

  it('should correctly detect the first menu element', () => {
    expect(dropdown._menuElement.localName).to.be.eql('vaadin-list-box');
  });
});
...
describe('vaadin-dropdown-menu with-value', () => {
  ...
  beforeEach(done => {
    ...
    afterNextRender(menu, () => setTimeout(done));
  });
